...
\subsection{Phase of Flight Identification} \label{sec:phase_identification}
    ...
    \begin{table}
        ...
        \vspace{3pt}
        \centering
        \begin{tabular}{@{} >{\centering\arraybackslash} m{0.17\linewidth} m{.83\linewidth} @{}}
            \hline
...
\subsection{Phase of Flight Quality Analysis \& Exceedance Detection} \label{sec:phase_quality}
	...
	\subsubsection{Approach}
        ...
        \begin{table}
            ...
            \vspace{3pt}
            \centering
            \begin{tabular}{@{} >{\centering\arraybackslash} m{.15\linewidth} >{\raggedright\arraybackslash} m{.3\linewidth} m{.55\linewidth} @{}}
                \hline
        ...
        \begin{algorithm}
            ...
            \Function{AnalyzeApproach}{startTime, endTime, runway}
                ...
                \While{$\var{i} < \var{approachDataSlice.length}$}
                    ...
                    \State $ \var{crossTrackIsStable} \gets \var{calculateCrossTrack(airplanePoint, airplaneHdg, runway)} \leq 50\,\text{ft} $
        ...
        \paragraph{Final Turn}
            ...
            \begin{algorithm}
                ...
                \Function{AnalyzeFinalTurn}{startTime, endTime, runway}
                    ...
                    \State $ \var{crossTrackError} \gets \var{calculateCrossTrack(airplanePoint, airplaneHdg, runway)} $
        ...
        \paragraph{Self-Defined Glide Path}
            ...
            \begin{algorithm}[t]
                ...
                \Function{AnalyzeGlidePath}{startTime, endTime, runway}
                    ...
                    \State $ \var{regressionResult} \gets \var{linearRegression(approachDataSlice[`time'], approachDataSlice[`agl'])} $
                    ...
                    \State $ \var{actualGlidePathAngle} \gets \var{degrees(atan(predictedVerticalDistance / horizontalDistance))} $
