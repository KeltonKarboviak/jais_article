...
\subsection{Accuracy of Phase Identification}
    ...
    \begin{figure}
    	\centering
        \includegraphics[width=0.85\linewidth]{kml_example}
...
\subsection{Quality Analysis}
    ...
    \subsubsection{Approach}
        ...
        \begin{figure}
            ...
            \subfloat[Frequency of parameters that caused an aircraft to be unstable during an approach.  Note that a single approach can have multiple unstable parameters.\label{subfig:unstable_parameters}]{
...
\subsection{Grading Metrics:  Defined From Parameter Frequencies}
    ...
    \subsubsection{Indicated Airspeed Between 55 and 75 knots}
		...
		\begin{figure}
			\centering
            \includegraphics[width=0.85\linewidth]{revised_ias_hist}
    ...
    \subsubsection{Vertical Speed Indicated Greater Than -1000 ft/min}
		...
		\begin{figure}[t]
			\centering
            \includegraphics[width=0.85\linewidth]{revised_vsi_hist}
    ...
    \subsubsection{Absolute Cross Track Error Less Than 50 ft}
		...
		\begin{figure}[t]
			\centering
            \includegraphics[width=0.85\linewidth]{revised_cross_track_hist}
    ...
    \subsubsection{Absolute Heading Error Less Than 10 degrees}
        ...
        \begin{figure}
			\centering
            \includegraphics[width=0.85\linewidth]{revised_heading_hist}
...
\subsection{Grading Metrics:  Experiment Results}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.85\linewidth]{metric_parameter_results}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.85\linewidth]{orig_scores_hist}
